...
const about = () => {
    return (
        <>
            <Head>
                <title>Fernando Barcelos rosito | About Page</title>
                <meta name="description" content="any descrition" />
            </Head>
                ...
                <Layout className='pt-16'>
                    ...
                    <div className='grid w-full grid-cols-8 gap-16'>
                        ...
                        <div className='absolute top-0 -right-3 -z-10 w-[102%] h-[103%] rounded-[2rem] bg-dark' />
                            <Image src={profilePic} alt="Fernando Barcelos Rosito" className="w-full h-auto rounded-2xl" />
                        </div>
